...
model. However, an analytic result is difficult to obtain for the case of the full first
order solution in terms of Hankel functions with the phase information included. The analytic
...
quantities. The analytic solution of \eq{eq:KG2-source-ntime} for this choice of first order
