...
% $Id: results.tex,v 1.19 2009/10/14 11:33:07 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: results.tex,v 1.19 2009/10/14 11:33:07 ith Exp $}
...
The final model $V(\vp)=\msqphisqwithV$ is nominally a hybrid inflation model requiring two fields.
...
This first demonstration has been limited ourselves to considering
