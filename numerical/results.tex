...
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
\subsection{Comparison of \texorpdfstring{$V(\vp)=\msqphisq$}{m-squared Model} Results with Analytic
Solution}
...
solution is given in Appendix~\ref{sec:analyticsrc-apx} in Eqs. (\ref{}-\ref{}).
...
values of $k$ due to the divergence of the analytical solution as $k$ approaches zero. This
divergence is not replicated in the calculated version. However, this only strongly affects the
...
\begin{figure}
 ...
 % analytic_v_calced_61beforeend_errors-large.pdf: 432x324 pixel, 72dpi, 15.24x11.43 cm, bb=0 0 432
324
