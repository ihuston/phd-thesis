...
% $Id: results.tex,v 1.7 2009/10/06 16:06:32 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: results.tex,v 1.7 2009/10/06 16:06:32 ith Exp $}
...
-\frac{Q^2}{2(aH)^2}\right] \dvp1(\qvi)A(\qvi) \nonumber \\
% 
&- \frac{(8\pi G)^2}{(aH)^2}\frac{(\dN{\vp_0})^2 Q}{2} \dN{\dvp1}(\qvi)
A(\qvi) \nonumber \\
% 
&+ \frac{2(8\pi G)Q}{(aH)^2} \dvp1(\qvi)\wt{C}(\qvi) 
% 
+ \frac{8\pi G \dN{\vp_0}}{2} \dN{\dvp1}(\qvi) \wt{C}(\qvi) \Bigg\} \nonumber \\
% 
