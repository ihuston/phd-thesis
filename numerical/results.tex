...
% $Id: results.tex,v 1.28 2009/11/17 13:39:39 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: results.tex,v 1.28 2009/11/17 13:39:39 ith Exp $}
...
term \eqref{eq:KG2-source-ntime} for $\kwmap$ over the three different ranges $K_1$,
$K_2$ and $K_3$, specified in \eq{eq:Kranges-res}.} 
...
pivot scale, $\kwmap=5.25\e{-60}\Mpl$. As $k$
...
term at the initial start time for each $k$ when $k/aH = 50$ deep inside
the
