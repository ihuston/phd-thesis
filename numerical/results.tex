...
% $Id: results.tex,v 1.15 2009/10/13 19:31:50 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: results.tex,v 1.15 2009/10/13 19:31:50 ith Exp $}
...
As a proof of concept the system was tested with four different
...
We have also outlined in \eq{eq:Krangedefns} the three $k$ ranges that we will use,
% 
\begin{eqnarray*}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{numerical/graphs/src_3ns-large}
...
Full second order equation in terms of $\N$:
\begin{multline}
 \label{eq:fullso-res}
...
$\theta\rightarrow 0$.
% 
The full $F$ term can now be written:
\begin{align}
