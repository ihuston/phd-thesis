...
% $Id: results.tex,v 1.4 2009/10/05 15:19:58 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: results.tex,v 1.4 2009/10/05 15:19:58 ith Exp $}
...
% 
\subfloat[Power spectrum of scalar perturbations $\mathcal{P}_{\delta\varphi} =
...
\caption{Comparison of the source term for $\kwmap$ over three
different ranges with different $\Delta k$s as specified in
\eq{eq:Krangedefns}.} 
...
\caption{The source term for three different $k$ values including the WMAP
pivot scale. As $k$
...
\caption{The source term (lower blue line) is compared with the $T$ term
...
\caption{The quotient of $S$ and $T$ terms for three different $k$ values
...
\begin{figure}
\centering
 \subfloat[The $\lambdaphifour$ model (green dashed line) initially has a
...
% 
\subfloat[The crossover between the models at the early stages of the
