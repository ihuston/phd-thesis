...
% $Id: perts.tex,v 1.16 2009/10/10 11:07:57 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: perts.tex,v 1.16 2009/10/10 11:07:57 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
$\bar{\epsilon}_H$ as defined in Refs.~\cite{Malik:2006ir} and
\cite{Seery:2005gb} 
(which is the square-root of the usual $\epsilon_H$ used in
Chapter~\ref{ch:introduction}) is given by
%
\begin{equation}
 \bar{\epsilon}_H = \sqrt{4\pi G} \frac{\vp_{0}'}{\H}\,.
\end{equation}
%
