...
% $Id: perts.tex,v 1.19 2009/10/11 11:19:48 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: perts.tex,v 1.19 2009/10/11 11:19:48 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
\eq{eq:KG2-fourier-sr-num}, the first
...
In this limit the real space expression for $\R_2$ is
% 
\begin{equation}
...
\end{equation}
% 
In Fourier space this term becomes
% 
\begin{align}
...
%  
&+\frac{1}{\left(\vp_0'\right)^2} \left(\H\frac{\vp_0''}{\vp_0} 
 - \H' -2\H^2 \right) \dvp1(\eta,\pvi) \dvp1(\eta, \qvi)\Bigg\}\,.
\end{align}
