...
% $Id: perts.tex,v 1.11 2009/10/08 14:57:35 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: perts.tex,v 1.11 2009/10/08 14:57:35 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
the data. In Section~\ref{sec:perts-intro} cosmological perturbations at first order
...
Eqs.~\eq{eq:Prdefn-intro} and \eq{eq:Ptdefn-intro} should match
...
far to only be usable on scales much larger than the particle horizon.  
The
