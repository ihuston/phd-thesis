...
% $Id: perts.tex,v 1.13 2009/10/08 21:35:23 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: perts.tex,v 1.13 2009/10/08 21:35:23 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
We will consider perturbations of a single scalar field
and as in Section~\ref{sec:perts-intro} we will work in the uniform curvature or flat
gauge. The
goal is to describe scalar perturbations up to second order and the
first step to achieve this is to examine the metric
tensor up to second order.  This is
a straightforward extension of \eq{eq:pertmetric-intro} with the vector and tensor
perturbations ignored:
%
\begin{align}
...
\end{equation}
% 
where the tilde denotes quantities in the flat gauge.
