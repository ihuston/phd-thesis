...
% $Id: perts.tex,v 1.33 2009/11/30 12:11:02 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: perts.tex,v 1.33 2009/11/30 12:11:02 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
\end{align}
% 
and $B_{1i}$ and $C_{1ij}$ were defined in \eq{eq:svt-intro}.
...
\end{equation}
% 
\eq{eq:fnlampl-perts} provides a blueprint for how to evaluate the bispectrum in terms of a
