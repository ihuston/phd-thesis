...
% $Id: perts.tex,v 1.23 2009/10/14 13:04:02 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: perts.tex,v 1.23 2009/10/14 13:04:02 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
\eq{eq:psi2transform-perts} to be
\begin{equation}
...
The Klein-Gordon equations describe the evolution of the scalar field and are
...
considering the
evolution of the second order perturbation in the slow roll approximation. 
...
\end{equation}
%
The second slow roll parameter is still $\eta_H$. Following \Rref{Malik:2006ir} we
...
\eq{eq:KG2-fourier-sr-num}, the full first
order equation (\ref{eq:fokg}) and the full background equation
(\ref{eq:KGback-num}). 
% 
% 
% 
...
\end{equation}
% 
By using the background evolution equation \eq{eq:KGback-num} and going to Fourier
...
described in Chapter~\ref{ch:numericalsystem} this quantity could be evaluated after
horizon crossing.
...
Fourier space using \eq{eq:Rfulldefn-perts} gives
% 
\begin{align}
...
\end{align}
% 
Calculating $\dvp2$ and $\R_2$ would provide a direct insight into the behaviour and
...
\eq{eq:quantcondition-intro}. This constraint also fixes the quantisation for all
...
of this approach is the necessity of convolution integrals of the first order
...
ultimately in the multi-field case given in \Rref{Malik:2006ir}. Understanding
