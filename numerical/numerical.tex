...
% $Id: numerical.tex,v 1.15 2009/10/05 15:19:58 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: numerical.tex,v 1.15 2009/10/05 15:19:58 ith Exp $}
...
\centering
% 
 \subfloat[The relative error for different $N_\theta$, the number of
...
% 
\subfloat[The relative error for the 3 different $k$ ranges $K1$, $K2$,
