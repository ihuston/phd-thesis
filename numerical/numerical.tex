...
% $Id: numerical.tex,v 1.27 2009/10/11 19:46:53 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: numerical.tex,v 1.27 2009/10/11 19:46:53 ith Exp $}
...
For each potential there is one parameter that needs to be determined.
We choose the parameters $m$,$\lambda$,$\sigma$ and $m_0$ to be in agreement with the
WMAP5 curvature perturbation value at the pivot scale
$\kwmap=0.002\Mpc^{-1} \simeq5.25\times10^{- 60} \Mpl$. 
The dependence of $\Pr$ on each of the parameters can be seen in
Figure~\ref{fig:params-num}.
Requiring $\Pr=2.457\e{-9}$
...
\centering
 ...
 \caption[Plot of $\bar{\varepsilon}_H$ near the end of inflation]{The end of
inflation is
