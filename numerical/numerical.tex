...
% $Id: numerical.tex,v 1.19 2009/10/06 10:53:29 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: numerical.tex,v 1.19 2009/10/06 10:53:29 ith Exp $}
...
\label{eq:err-analytic-num}
 A(k) = \frac{\pi}{18}\frac{\alpha^2}{k} \Bigg\{ 
