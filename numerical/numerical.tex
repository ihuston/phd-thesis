...
% $Id: numerical.tex,v 1.26 2009/10/11 17:29:53 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: numerical.tex,v 1.26 2009/10/11 17:29:53 ith Exp $}
...
inflation and $H_\mathrm{reh} = H_\mathrm{reh}$. This gives approximately 65
...
$\kwmap=0.002\Mpc^{-1} \simeq5.25\times10^{- 60} \Mpl$ with the values
$m=6.3267\times10^{-6}
...
\caption[Different potentials used]{Plots of the different potentials used. The
potentials for the $\hybridtwoandfour$ and $\linde$ models with the parameters
described are indistinguishable from the $\lambdaphifour$ potential.}
\label{fig:potentials-num}
\end{figure}

\begin{figure}
\centering%
\subfloat[The potentials in terms of $\varphi$.]{
\includegraphics[width=0.43\textwidth]
  {numerical/graphs/cmp_pot_phi_msqlphphi23-small}
}\qquad%
\subfloat[The potentials in terms of $\N$.]{
 \includegraphics[width=0.43\textwidth]
  {numerical/graphs/cmp_pot_n_msqlphphi23-small}
}
\caption[Comparison of potentials]{A comparison of the different potentials used.}
