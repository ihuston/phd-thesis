...
% $Id: numerical.tex,v 1.49 2009/11/20 15:33:25 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: numerical.tex,v 1.49 2009/11/20 15:33:25 ith Exp $}
...
three final $k$ ranges with $\beta=10^_{-62}$. The errors
...
errors for $I_\B$,
$I_{\wt{\C}}$ and $I_{\wt{\D}}$ for each of the $k$ ranges with $\beta=10^_{-62}$.}
