...
% $Id: numerical.tex,v 1.38 2009/11/05 18:03:17 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: numerical.tex,v 1.38 2009/11/05 18:03:17 ith Exp $}
...
$I_{\wt{\C}}$ and $I_{\wt{\D}}$ are shown in Figure~\ref{fig:rel-bcd-num}. The errors
...
\caption[Relative errors for three other terms]{The relative errors for $I_\B$,
$I_{\wt{\C}}$ and $I_{\wt{\D}}$ for each of the $k$ ranges.}
