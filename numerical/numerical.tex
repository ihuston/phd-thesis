...
% $Id: numerical.tex,v 1.40 2009/11/05 19:16:00 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: numerical.tex,v 1.40 2009/11/05 19:16:00 ith Exp $}
...
\begin{figure}[htb]
 ...
 \caption{The analytic solution for $I_\A$ given in \eq{eq:err-analytic-num} for
