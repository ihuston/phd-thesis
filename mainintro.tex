...
% $Id: mainintro.tex,v 1.19 2009/08/19 17:22:42 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.19 2009/08/19 17:22:42 ith Exp $}
...
Inflation offers solutions for these problems and also provides an explanation
for the fluctuations in energy density required to seed galaxy and star
formation. In essence inflation is a period of accelerated growth of the
universe or correspondingly an era when the comoving horizon decreases.  The
acceleration 
\begin{equation}
