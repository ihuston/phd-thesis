...
% $Id: mainintro.tex,v 1.66 2009/11/27 17:43:24 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.66 2009/11/27 17:43:24 ith Exp $}
...
From the metric in \eq{eq:frwmetric-intro}, the $0$-$0$ and $i$-$j$ components of the
...
% 
\begin{figure}[htbp]
 \includegraphics[width=0.8\textwidth]{graphs/scales.pdf}
