...
% $Id: mainintro.tex,v 1.51 2009/10/15 17:23:17 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.51 2009/10/15 17:23:17 ith Exp $}
...
modes
are inside the horizon, $k\gg aH$. In this limit the FRW background spacetime
...
Currently the WMAP5 limits on $\fnlloc$, presented in \eq{eq:fnlloc-wmap5-intro}, are
centred around $\fnlloc=60$ but
still include $\fnlloc=0$ at the 95\% confidence level.
...
equilateral triangle, given in \eq{eq:fnleq-wmap5-intro}, is $-151 < \fnl <
253$.
