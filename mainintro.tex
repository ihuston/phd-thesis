...
% $Id: mainintro.tex,v 1.18 2009/08/19 12:10:15 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.18 2009/08/19 12:10:15 ith Exp $}
...
or open respectively. In this work we will consider only the flat universe and
take $K=0$ from now on. The time-like coordinate in the metric is $t$, known as
...
\eq{eq:comovingdefn-intro} this is simply
% 
\begin{equation}
 \label{eq:particlehorizon-intro}
 \chi = \int_{t_i}^t \frac{\d t}{a(t)}\,.
\end{equation}
This is known as the particle horizon. If the initial time is restricted to
...
this finite distance could never have been in causal contact in the past. 
