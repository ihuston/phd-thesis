...
% $Id: mainintro.tex,v 1.14 2009/08/18 11:41:28 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.14 2009/08/18 11:41:28 ith Exp $}
...
is formalised by assuming that the universe is homogenous and isotropic, at
...
\end{eqnarray}
where $\mathcal{L}_\mathrm{M}$ is the sum of the Lagrangian densities for all
the matter fields.
...
Suppose $u^\mu$ is the 4-velocity of a perfect fluid with $u^\mu u_\mu=-1$ then
