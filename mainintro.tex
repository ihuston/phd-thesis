...
% $Id: mainintro.tex,v 1.21 2009/08/24 11:04:03 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.21 2009/08/24 11:04:03 ith Exp $}
...
\end{itemize}
We have seen how observations place a lower limit on the
duration of inflation. One of the main constraints in formulating models of
inflation is finding potentials that generate such a long duration. 
...
One of the main achievements of inflation is to provide a physical origin for
such initial fluctuations. Suppose that a full inhomogeneous scalar field
...
If $\epsilon$ is a small quantity then this can be written as 
% 
\begin{equation}
\label{eq:pertsplit-intro}
\vp(x, t) = \vp_0(t) + \epsilon\dvp{}(x,t) \,.
\end{equation}
% 
