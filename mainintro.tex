...
% $Id: mainintro.tex,v 1.15 2009/08/18 13:32:37 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.15 2009/08/18 13:32:37 ith Exp $}
...
\end{eqnarray}
% 
Here $\mathcal{L}_\mathrm{M}$ is the sum of the Lagrangian densities
