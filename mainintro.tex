...
% $Id: mainintro.tex,v 1.34 2009/08/30 16:45:57 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.34 2009/08/30 16:45:57 ith Exp $}
...
allowed by the observations [cite].
...
cosmological constant term, $\Lambda_c$, for completeness. From now on we will
...
at later times. These different dominant components change the rate of expansion
...
problem. We go on to describe canonical slow-roll inflation, the generation of
...
which takes place before the start of the Big Bang. During this
