...
% $Id: mainintro.tex,v 1.27 2009/08/27 10:35:22 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: mainintro.tex,v 1.27 2009/08/27 10:35:22 ith Exp $}
...
The choice of vacuum state is not straightforward in the FRW background. 
...
\addtodo{Change to defn in terms of post quantum modes.}
...
\addtodo{Add section on separate universe approach?}
...
\addtodo{Tensor perturbation derivation}
