...
% $Id: dbi-intro.tex,v 1.28 2009/08/05 13:25:33 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.28 2009/08/05 13:25:33 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
manifold contains one or more throats. 
...
In terms of the fluxes defined in \eq{eq:fluxdefn-dbiintro} $N=MK$.
...
of a probe ${\rm D3}$-brane in a warped throat, as described in Section
\ref{sec:warpedthroats-dbiintro}, is determined 
