...
% $Id: dbi-intro.tex,v 1.10 2009/07/28 11:45:30 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.10 2009/07/28 11:45:30 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
\addtodo{ Change to chapter structure.}
...
\addtodo{ Link to slow roll introduction}
% 
\begin{eqnarray}
...
\addtodo{ Talk about difference with standard k=aH}
...
\addtodo{Link to intro section on $\fnl$}
It is conventional 
...
\addtodo{ Put back into introduction above.}
