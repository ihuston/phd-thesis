...
% $Id: dbi-intro.tex,v 1.21 2009/08/01 16:03:06 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.21 2009/08/01 16:03:06 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
\section{Branes and extra dimensions}
\label{sec:extradims}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
Unifcation of seemingly disparate theories has been a driving force in
theoretical physis for more than 100 years. This effort culminated in the
...
the SM a clear goal of theoretical phsyics has been the unification of the
...
universe are vibrating bunles of energy. These ``strings'', and their analogues
...
so successfully tested experimentally.

This at least is the goal of the string theory project but the coimplex nature
...
Suppose we wish to reduce a theory in $(D+1)$ dimensions to one in $D$ dimensions. 
