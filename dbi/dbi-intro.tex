...
% $Id: dbi-intro.tex,v 1.6 2009/07/20 16:46:09 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.6 2009/07/20 16:46:09 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
in Section \ref{sec:dbiinflation}. In Sections \ref{sec:upper-dbi} and  
\ref{sec:lower-dbi}, we derive the respective 
...
Section \ref{sec:relaxing-dbi} and discuss multi-brane 
IR scenarios in Section \ref{sec:multiple-dbi}. Finally, we conclude  
