...
% $Id: dbi-intro.tex,v 1.30 2009/08/05 22:25:30 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.30 2009/08/05 22:25:30 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
Cosmology can be used to constrain string theory. Much of the evidence of an
...
One method would be to look for signals that are generic in string theory and
see if they are observed. Conversely any observed signal that is rare in string
theory could also yield information.

One particularly good indicator is the non-gaussianity parameter $\fnl$.
Standard inflation models tend not to produce much non-gaussianity, whereas
