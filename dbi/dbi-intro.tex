...
% $Id: dbi-intro.tex,v 1.20 2009/08/01 15:50:54 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.20 2009/08/01 15:50:54 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
The discussion of the next three chapters takes place in the realm of superstring theory, 
and we first introduce some of the concepts that we will need. The development of the theory
is well documented and extensive and here we will focus only on those parts of the theory 
that concern DBI inflation. 
Standard background texts on string theory as a whole include ***.
