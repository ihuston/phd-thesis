...
% $Id: dbi-intro.tex,v 1.34 2009/08/31 16:04:30 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.34 2009/08/31 16:04:30 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
unification of physics. In this theory, the fundamental
...
to be the most
fruitful for models of cosmological inflation, Type IIB \cite{cline,
Linde:2005dd}. 
% 
...
\begin{equation}
 L \rightarrow L' = \frac{\alpha'}{L}\,.
\end{equation}
Writing the equations of motion in terms of $L'$, having swapped $j$ and $w$,
gives a new theory
which is compactified on a circle of radius $L'$. This is known as the
...
dimension similar to standard KK compactification \cite{Johnson2000}.
...
tension \cite{Johnson2000}\footnote{$T_p$ here is $\tau_p$ in
\cite{Johnson2000}.}
% 
\begin{equation}
...
\eq{fnldefn-dbiintro}. When $c_s\PX=1$ the term $\Lambda$ defined in
...
For a homogeneous field $2X = \dot{vp}^2$ so from \eq{eq:csdefn-dbiintro} we get
\begin{equation}
...
complicated geometries and additional fluxes must be used to stabilize the
remaining moduli fields. 
The DBI scenario is an example of a non-canonical infaltionary model. With a
