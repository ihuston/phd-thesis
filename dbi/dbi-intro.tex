...
% $Id: dbi-intro.tex,v 1.51 2009/10/21 14:49:17 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.51 2009/10/21 14:49:17 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
inflaton fluctuations, defined by \eq{eq:defcs-dbiintro}. For the kinetic function in
...
To summarise thus far, in this section we have introduced the standard DBI
inflationary scenario. This
is a particular example of the non-canonical inflationary paradigm described in
Section~\ref{sec:noncanoninfl}. In the case of DBI inflation the speed of sound
parameter
...
The DBI scenario is an example of a non-canonical inflationary model. 
