...
% $Id: dbi-intro.tex,v 1.23 2009/08/03 16:24:09 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi-intro.tex,v 1.23 2009/08/03 16:24:09 ith Exp $}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
The early work of Kaluza and Klein in dealing with higher dimensional 
theories has played
a large role in the formation of consistent theories of extra dimensions in
...
The extra dimensions are
compactified into a Ricci flat Calabi-Yau (CY) manifold which can be described
by three complex coordinates \cite{Yau1977}. Now any Ricci flat metric can be
rescaled into another Ricci flat metric so there is no unique solution for the
...
These moduli fields must
be ``stabilized'', given an effective mass so that they do not interfere as
massless fields, 
 Flux
compactification is used, which entails the switching on of ``fluxes'' during
