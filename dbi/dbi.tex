% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.10 2009/07/28 09:23:48 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.10 2009/07/28 09:23:48 ith Exp $}
% \input{paper1}
...
% TODO: Add figure with throat geometry
...
violated after observable scales have crossed the horizon. %TODO: Example
Furthermore, $N \gg 1$ is necessary 
for backreaction effects to be negligible. %TODO: Citation
...
${r} \, {\gsim} \, 10^{-4}$ \cite{clover,vpj}. %TODO: Update refs (clover now longer funded)
If CMB  
...
% TODO: Check WMAP5 has the same numbers
...
\begin{equation}
\label{eq:defvarphi}
\tilde{\varphi} \equiv \int d \phi \sqrt{\frac{f_1f_2}{2}}  \,.
\end{equation}
% 
...
% TODO: Change to standard spectrum definition 
% 
\begin{equation}
...
% TODO: Rewrite in terms of thesis
