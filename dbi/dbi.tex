% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.47 2009/09/28 16:03:43 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.47 2009/09/28 16:03:43 ith Exp $}
...
must satisfy $| \Delta \varphi_*|<\varphi_{UV}$. So it follows from   
...
of the brane being used as the inflaton, moduli fields associated with Wilson
lines are turned on and
