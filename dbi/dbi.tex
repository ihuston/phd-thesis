% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.29 2009/09/18 15:24:08 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.29 2009/09/18 15:24:08 ith Exp $}
...
rely on other physical mechanisms to ease the above bounds. Wrapping branes
around the compact extra dimensions leads to a change in the relationship
between $\rho$ and $\vp$ from that defined in Section~\ref{sec:dbiinflation}
\cite{Kobayashi:2007hm, Becker:2007ui, Ward:2007gs}.  This allows the bounds on
$r$ to be eased but the parameter space of these models is still severly
...
Refs.~\cite{Easson:2009kk} and \cite{Huang:2007hh}. Increasing the degrees of
...
the same or different sound speeds \cite{Cai:2008if, Cai:2009hw}, or apply the
curvaton scenario [cite***] to the DBI case \cite{Li:2008fm, Kobayashi:2009cm}.
