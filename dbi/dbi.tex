% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.21 2009/09/16 12:53:50 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.21 2009/09/16 12:53:50 ith Exp $}
% \input{paper1}
...
A direct comparison with Eq. (\ref{eq:Pdefn-dbiintro}) 
...
Eq. (\ref{eq:Pdefn-dbiintro}) through the field redefinition 
% 
\begin{equation}
\label{eq:defvarphi}
