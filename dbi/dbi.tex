% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.60 2009/11/06 12:36:39 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.60 2009/11/06 12:36:39 ith Exp $}
...
models. 
These have a single degree of freedom, as the D3-brane model does, but
...
Changing the physical setting can also allow larger field ranges which can relax the
bounds on $r$. One example is the case of D4-branes in compactified manifolds
...
significantly altered if the throat geometry changes, even in the case of the
standard D3-brane model \cite{Gmeiner:2007uw}. In
\Rref{Butti:2004pk} a one parameter family of solutions is given, which interpolates
between the
...
field ranges and an observable tensor signal are possible \cite{Krause:2007jr}. 
Another proposal is that of $n$ D3-branes which are coincident propagating in a
