% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.54 2009/10/27 19:01:36 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.54 2009/10/27 19:01:36 ith Exp $}
...
whether they involve single or multiple fields. 
...
have proposed a model where inflation is driven by a warped ${\rm D5}$-brane. 
...
dependence on the charge since
...
still much better than the single brane scenario, which
requires a
...
single brane models but the parameter space of the former is still severly
...
T-dual to the
standard DBI model with non-parallel branes. The upper bound on $r$
...
% 
Changing the physical setting can also allow larger field ranges. By considering
...
freedom in this way introduces the possibility of entropy mode production. There is a
