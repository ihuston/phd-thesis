% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.31 2009/09/18 16:29:46 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.31 2009/09/18 16:29:46 ith Exp $}
...
Since the field value during observable inflation $\varphi_* < \varphi_{UV}$,
...
\end{equation}
% 
where the effective number of e-foldings $\Neff \equiv 
\int^{\N_{\mathrm{end}}}_0 d \N (r/r_*)^{1/2}$ 
is a model-dependent parameter that quantifies 
how $r$ varies during the final stages of inflation. If $r$ is constant during
inflation then $\Neff = \N_\mathrm{end}$.
