% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.39 2009/09/22 10:09:54 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.39 2009/09/22 10:09:54 ith Exp $}
...
In \Rref{bmpaper} Baumann and McAllister (BM)  
...
\end{equation}
% 
\addtodo{Should the above be removed if duplicate? Change to cite chapter not
paper.}
...
Comparison of the limits (\ref{eq:genBMbound}) and (\ref{eq:LHbound})
...
% 
\addtodo{Remove or change to version in paper2}
\begin{equation}
