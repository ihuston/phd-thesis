% % % % % % % % % % % % % % % % % % % % % 
% dbi.tex - Ian Huston
% $Id: dbi.tex,v 1.11 2009/07/28 09:51:26 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: dbi.tex,v 1.11 2009/07/28 09:51:26 ith Exp $}
% \input{paper1}
...
that $\dot{\varphi}^2 /\Mpl^2 = 2\epsilon H^2/P_{,X}$.
