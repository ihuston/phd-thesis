...
% $Id: multibrane.tex,v 1.55 2009/10/27 17:11:52 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: multibrane.tex,v 1.55 2009/10/27 17:11:52 ith Exp $}
...
which the kinetic function $P$ takes the form given in \eq{eq:Pdefn-dbiintro}:
%  
\begin{equation}
\label{eq:DBIkinetic}
...
\end{equation}
% 
Recall that the definitions of $c_s^2$ and $\Lambda$ in \eqs{eq:defcs-dbiintro} and
...
scenarios in the limit where $c_s^2$ is small and $\Lambda$ is large or equivalently:
...
% =========================================================== %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
\section{The Multiple Coincident Brane Model} 
...
$P_n$ and $E_n$ to denote the non-singlet sector of the kinetic and energy density for
...
\gsim 70$ if such configurations are to generate a detectable tensor 
