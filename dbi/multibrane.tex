...
completeness we show in Appendix~\ref{sec:apx-multi} that \eq{eq:defalpha} can be solved
...
% % % % % % % % % % % % % % % % % % % % % % % % 
\subsection{\texorpdfstring{Bound on $n$ during IR propagation}{Bound on n during IR propagation}}
