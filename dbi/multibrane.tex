...
% $Id: multibrane.tex,v 1.20 2009/09/16 13:08:04 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: multibrane.tex,v 1.20 2009/09/16 13:08:04 ith Exp $}
...
\frac{NT_3h^4_*}{\Mpl^4} < 
\frac{8\pi^2 (1-n_s)P_S^2}{\sqrt{-3\fnl}(\Delta \N_*)^2} \,.
\end{equation}
% 
...
\begin{equation}
\label{eq:Nlimit-dbi}
N< \frac{8\pi^2 (1-n_s)P_S^2}{\sqrt{-3\fnl} ( \Delta \N_*)^2}
...
\label{eq:nlimit-dbi}
\hat{C} \ll 
\frac{32 \pi^4 (1-n_s)P_S^2}{\sqrt{-3\fnl} ( \Delta \N_*)^2}
...
-\ln \left( 
\frac{64\pi^5 (1-n_s)P_S^2}{\sqrt{-3\fnl} ( \Delta \N_*)^2}
\right) \,.
\end{equation}
% 
...
Eq. (\ref{eq:DBIaction-dbiintro2})  takes the form
%  
\begin{equation}
\label{eq:DBIkinetic}
