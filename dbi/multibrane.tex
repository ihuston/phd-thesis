...
% $Id: multibrane.tex,v 1.11 2009/07/20 15:42:17 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: multibrane.tex,v 1.11 2009/07/20 15:42:17 ith Exp $}
...
% TODO: Move to extensions and alternatives chapter?
...
% TODO: Put into main intro or earlier
...
% TODO: Rewrite as reference to previous chapter keeping labels intact
...
% TODO: Change to reference chapter not paper.
...
\end{equation}
% 
% TODO: Change to cite chapter not paper
...
(\ref{deffnl}) from the general expressions (\ref{eq:2brane}) and (\ref{eq:oddbrane}) 
...
(\ref{eq:rellimit-multi}) into the scalar perturbation amplitude, Eq. (\ref{eqn:Ps2}),
that 
% 
\begin{equation}
