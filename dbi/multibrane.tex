...
% $Id: multibrane.tex,v 1.23 2009/09/16 16:12:37 ith Exp $
% % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}{\version$Id: multibrane.tex,v 1.23 2009/09/16 16:12:37 ith Exp $}
...
\frac{NT_3h^4_*}{\Mpl^4} < 
\frac{8\pi^2 (1-n_s)\Pr}{\sqrt{-3\fnl}(\Delta \N_*)^2} \,.
\end{equation}
% 
...
\begin{equation}
\label{eq:Nlimit-dbi}
N< \frac{8\pi^2 (1-n_s)\Pr}{\sqrt{-3\fnl} ( \Delta \N_*)^2}
...
\label{eq:nlimit-dbi}
\hat{C} \ll 
\frac{32 \pi^4 (1-n_s)\Pr}{\sqrt{-3\fnl} ( \Delta \N_*)^2}
...
-\ln \left( 
\frac{64\pi^5 (1-n_s)\Pr}{\sqrt{-3\fnl} ( \Delta \N_*)^2}
\right) \,.
\end{equation}
% 
...
> \frac{\sqrt{-3\fnl} ( \Delta \N_*)^2}{64\pi^5 
...
\end{equation}
% 
\addtodo{Should the above be removed if duplicate? Change to cite chapter not paper.}
...
\end{equation}
% 
We may therefore immediately conclude from \eq{eq:consequence4-multi} that $\fnl
...
r_* < -\frac{42}{N \Neff^2}\sqrt{1 +(n-1)^2Y}\fnl 
\end{equation}
%  
...
n > 1 -5.5 \times 10^{-14} N^{3/2} \Neff^2 \fnl 
\end{equation}
% 
...
-5.5 \times 10^{-14} N^{3/2} \Neff^2 \fnl  <1  \, .
\end{equation}
% 
