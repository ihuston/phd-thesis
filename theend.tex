...
% $Id: theend.tex,v 1.7 2009/11/09 18:15:40 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}%
{\version$Id: theend.tex,v 1.7 2009/11/09 18:15:40 ith Exp $}
...
In Fourier space, the second order KG equation \eqref{eq:SOLG-real-num} contains a
