...
% $Id: theend.tex,v 1.19 2009/11/23 11:48:02 ith Exp $
% % % % % % % % % % % % % % % % % % % % % % 
% Redefine CVSRevision for this section
\renewcommand{\CVSrevision}%
{\version$Id: theend.tex,v 1.19 2009/11/23 11:48:02 ith Exp $}
...
Integrating the evolution
equation for a derived observable quantity instead, would add a degree of
separation from the physical origins of this process. Indeed, there is, as yet,
...
efficiency of the code will also relieve these constraints.
% 
